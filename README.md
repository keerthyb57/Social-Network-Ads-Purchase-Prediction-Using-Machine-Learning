This project uses Machine Learning (Random Forest Classifier) to predict whether a user will purchase a product based on social network advertisement data.
...
from sklearn.ensemble import RandomForestClassifier->Use: Imports the Random Forest algorithm to build the prediction model.
